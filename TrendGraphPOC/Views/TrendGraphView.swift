              ...
              ZStack {
                  GeometryReader { geometry in
                      Chart {
                          ...
                          // Points on the chart
                          ForEach(viewModel.filteredGlucoseValues) { value in
                              PointMark(
                      ...
                      .chartXAxis {
                          AxisMarks(values: viewModel.getXAxisComparableValues(selectedTimeRange: viewModel.selectedTimeRange)) { value in
                              AxisTick()
